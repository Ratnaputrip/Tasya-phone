            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                 ...
                 <a href="<?= site_url('masuk/artikel'); ?>"> <button type="submit" class="btn btn-primary pull-right">Kelola</button></a>
                </div>
                ...
                <?php 
                   $form = new ecrud();
                  $form->init('edit');
                  $id_artikel = $this->input->get('artikel');
                  $form->setTable('artikel');
                  $form->setId($id_artikel);
                  $form->addInput('alamat','text');
                  $form->addInput('no_telp','text');
                  $form->setType('no_telp','number');
                  
                  $form->addInput('iklan','upload');
                  $form->addInput('diskon','text');
                  $form->addInput('cara_pesan','textarea');
                  $form->form();
